...
with st.sidebar.form("book_form"):
    ...
    new_genre = st.selectbox("Gemre", books_df['Genre'].unique())
...
if submit_button:
    ...
    books_df.to_csv('bestsellers_with_categories_2022_03_27', index=True)
...
min_rating = st.sidebar.slider("Minimum User Rating", 0.0, 5.0, 0.1)
...
fig = px.pie(books_df, names='Genre', title='Most linked Genre(2009-2022',color='Genre',
